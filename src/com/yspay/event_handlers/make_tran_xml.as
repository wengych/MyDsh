...
package com.yspay.event_handlers
{
    ...
    public function make_tran_xml(ui_comp:UIComponent, source_event:Event, action_info:XML):void
    {
        ...
        var ys_pod:YsPod = UtilFunc.GetParentByType(ui_comp.parent as Container,
                                                    YsPod) as YsPod;
        var xml:XML =
            <L TYPE="TRAN" NAME="IDNUMBER" VER="20091120999999" ISUSED="0" APPNAME="MapServer" CUSER="xing"></L>
            ;
        var child_wnd:Object;
        var P_data:Object = ys_pod.D_data;
        var ename:String = ''; //P_data._data["__W_ENAME"][0]; // wnd.main_bus.GetFirst("__W_ENAME");
        var cname:String = ''; //P_data._data["__W_CNAME"][0]; // wnd.main_bus.GetFirst("__W_CNAME");
