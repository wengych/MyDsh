package com.yspay.util
{
     ...
     *  </pre>
     */
    public dynamic class YsObjectProxy extends Proxy implements IExternalizable, IPropertyChangeNotifier
    {
        //--------------------------------------------------------------------------
        //
        //  Constructor
         ...
         *  </pre>
         */
        public function YsObjectProxy(item:Object=null, uid:String=null,
                                      proxyDepth:int=-1)
        {
            super();
         ...
         */
        protected var proxyClass:Class = YsObjectProxy;
        ...
        override flash_proxy function getProperty(name:*):*
        {
            ...
            if (result)
            {
                if (_proxyLevel == 0 || isSimple(result))
                {
                    return result;
                }
                else
        ...
        override flash_proxy function setProperty(name:*, value:*):void
        {
            ...
            if (oldVal !== value)
            {
                ...
                if (dispatcher.hasEventListener(PropertyChangeEvent.PROPERTY_CHANGE))
                {
                    ...
                    var event:PropertyChangeEvent = PropertyChangeEvent.createUpdateEvent(
